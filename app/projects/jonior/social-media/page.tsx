...
import { overviewData, socialMediaData } from "@/_data/socialMediaData";

function Page() {
  return (
    <section className="mx-auto text-white">
      <div className="sm:mx-10 mx-4 px-4 py-8 flex flex-col max-sm:items-center shadow-lg rounded-b-md relative">
        <div className="min-h-screen text-white">
          <div className="max-w-6xl mx-auto">
            <header className="mb-10 max-sm:text-center">
            ...
            <h2 className="text-xl font-bold mb-6 max-sm:text-center">
              Overview - Today
            </h2>
